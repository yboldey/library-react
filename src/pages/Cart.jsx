                    ...
                    <div className="row">
                        ...
                        <div className="cart">
                            <div className="cart__header">
                                ...
                                <span className="cart__total">Total price</span>
                            </div>
                                        ...
                                        return (
                                            <div className="cart__item">
                                                <div className="cart__book">
                                                    <img src={book.url} className='cart__book--img' alt="image here" />
                                                ...
                                                <div className="cart__total">
                                                    ${(book.quantity * (book.originalPrice || book.saleprice)).toFixed(2)}
                                                </div>
                                            </div>
                                        )
                                    })
